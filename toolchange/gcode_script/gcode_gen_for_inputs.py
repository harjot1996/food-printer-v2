...
# for ran in range(3):
 ...
 # G01 Y2 F500
 f.write("G01 Y"+str(DROPOFF[ran][3])+" F"+str(SPEEDDROPOFF[3])+"; set the correct y height in front of tool post " + str(ran)+"\n")
 
 # G01 Y3 Z2 F500
 f.write("G01 Y"+str(DROPOFF[ran][5])+" Z"+str(DROPOFF[ran][4])+" F"+str(SPEEDDROPOFF[5])+"; move diagonallly downwards in Y and Z direction\n")
 
 # G01 Y4 Z3 F500
 f.write("G01 Y"+str(DROPOFF[ran][7])+" Z"+str(DROPOFF[ran][6])+" F"+str(SPEEDDROPOFF[7])+"; move diagonallly downwards in Y and Z direction\n")
 
 # G01 Z4 F500
 f.write("G01 Z"+str(DROPOFF[ran][8])+" F"+str(SPEEDDROPOFF[7])+"; set the correct z height in front of tool post by moving back up\n")

 # G01 Y1 F4000
 f.write("G01 Y"+str(DROPOFF[ran][2])+" F"+str(SPEEDDROPOFF[2])+"; move back in the y direction from the tool post " + str(ran)+"\n")
 f.close()
